...
# How To Capture Multi-Chain Network Tokens?

In traditional finance, MicroStrategy has demonstrated how a single entity can build a massive position on a scarce asset, Bitcoin by using excess cash and low-cost debt to relentlessly acquire and hold it as a primary reserve asset.
...
To understand more about how MicroStrategy works see [The MicroStrategy Method](../how-to-capture-1-million-eth/the-microstrategy-approach.md).

## The Rezerve Approach

Rezerve applies a similar strategy but with Ethereum and other multichain network tokens without central gatekeepers.

When capital is inexpensive, Rezerve utilizes onchain bond sales and decentralized lending markets to expand its treasury. Unlike a corporation or billionaire-led strategy, Rezerve’s accumulation engine is fully community-driven. Participation is open to all, and benefits are distributed among all contributors.

Because Rezerve is entirely onchain and decentralized, its holdings are transparent and publicly verifiable at all times. There is no single point of failure. No entity, person, or government can seize control. The treasury belongs to the people.
...
To understand more about how Rezerve does the same see [The Rezerve Approach](../how-to-capture-1-million-eth/the-rezerve-approach.md).
...
Rezerve’s model follows a comparable high-risk, high-reward path. RZR’s performance depends on community trust, robust smart contract security, and Ethereum market cycles. As a token representing a claim on Rezerve’s growing ETH treasury and other network tokens like BNB, SOL that can be staked, deployed in DeFi, or used in governance, RZR’s price movements could be amplified in the same way MSTR’s stock was.
